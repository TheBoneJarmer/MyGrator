...
/**
  ...
  myColl= db_scheme.getCollection("My Collection");
  ~~~~~~
  ...
  ~~~~~~
  Schema db_scheme;
  Collection myColl(db_scheme, "My Collection");
  ~~~~~~
...
/**
  ...
  myTable= db_scheme.getTable("My Table");
  ~~~~~~
  ...
  ~~~~~~
  Schema db_scheme;
  Table myTable(db_scheme, "My Table");
  ~~~~~~
...
/**
  ...
  `SessionSettings` or by directly specifying a db_host name, TCP/IP port and user
  ...
  to connect to a different db_host in the list. Only if none of the hosts could
  ...
  to that db_host and never re-connected again. If the connection gets broken,
  ...
  */
  ...
  /**
    ...
    ~~~~~~
      ...
      Session from_uri("mysqlx://user:pwd@host:port/db_scheme?ssl-mode=disabled");


      Session from_options("db_host", port, "user", "pwd", "db_scheme");
...
/**
  ...
  ~~~~~~
    ...
    Client from_uri("mysqlx://user:pwd\@db_host:port/db_scheme?ssl-mode=disabled");


    Client from_options("db_host", port, "user", "pwd", "db_scheme");
