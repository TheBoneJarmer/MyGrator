...
#define MYSQLX_ERROR_MISSING_HOST_NAME "Missing db_host name"
...
/**
  ...
  @param host       server db_host DNS name, IPv4 address or IPv6 address
...
/**
  ...
  @note For failover configurations with multiple hosts this function
        will return only the last added db_host name. Same is true for the port
        or the priority associated with this db_host name.
